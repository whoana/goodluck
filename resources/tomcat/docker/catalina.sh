...
# -----------------------------------------------------------------------------
JAVA_OPTS="${JAVA_OPTS} -DIIP_LOG_HOME=/usr/local/tomcat/logs -DtestUploadPath=/usr/local/tomcat/upload -Dlogback.configurationFile=/usr/local/tomcat/logback/logback.xml"
